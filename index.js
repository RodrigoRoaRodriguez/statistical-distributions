...
const PDFS = {
  ...
  symmetricNormalBimodal: ({ xs = [0], mean = 0, variance = 1 } = {}) =>
  ...
  symmetricNormalTrimodal: ({ xs = [0], mean = 0, variance = 1 } = {}) =>
  ...
  uniform: ({ count = 1 } = {}) => function uniform(x) {
    return 1 / count;
  },
  uniformBimodal: ({ count = 1 } = {}) => function uniformBimodal(x) {
    return (x < count / 2 ? 2 : 1) / count;
  },
  uniformTrimodal: ({ count = 1 } = {}) => function uniformTrimodal(x) {
